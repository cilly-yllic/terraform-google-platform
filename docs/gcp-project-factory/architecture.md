...
02. terraform-gcp-project-factory module
...
|--------------|------|-------------|-----|
| `project-factory-{service}` | per-service。全 env の Project を累積管理 | `terraform-gcp-project-factory` | `terraform-project-factory` |
...
- [actions/dispatch/README.md](../actions/dispatch/README.md) — Action A の使い方
